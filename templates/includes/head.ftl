...
<link href="${ctx.contextPath}/.resources/magnolia-travels/web-resources/css/bootstrap.min.css" rel="stylesheet">
<link href="${ctx.contextPath}/.resources/magnolia-travels/web-resources/css/component.css" rel="stylesheet">

<link href="${ctx.contextPath}/.resources/magnolia-travels/web-resources/css/style.css" rel="stylesheet">

<link rel="stylesheet" type="text/css" media="only screen and (max-width: 480px), only screen and (max-device-width: 480px)" href="${ctx.contextPath}/.resources/magnolia-travels/web-resources/css/small-device.css" />
